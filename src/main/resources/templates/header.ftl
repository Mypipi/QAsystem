...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="https://cdn.jsdelivr.net/gh/Mypipi/WorldPress@v1.1/cyp.xyz/picture/tree.png">
    <title>首页 - 问答</title>
...
<div role="navigation" class="zu-top">
    <div class="zg-wrap modal-shifting clearfix" id="zh-top-inner">
        <a href="https://cyp.design" class="zu-top-link-logo" id="zh-top-link-logo" data-za-c="view_home" data-za-a="visit_home" data-za-l="top_navigation_zhihu_logo">牛客</a>
            ...
            <div class="zu-top-nav-live zu-noti7-popup zg-r5px no-hovercard" id="zh-top-nav-live-new" role="popup" tabindex="0">
                <div class="zu-top-nav-live-inner zg-r5px">
                    ...
                    <div class="zm-noti7-popup-footer">
                        ...
                        <a href="#" class="zm-noti7-popup-footer-set" title="通知设置"><i class="zg-icon zg-icon-settings"></i></a>
                    </div>
                </div>
            </div>
        </div>
